            ...
            <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b' key={index}>
              ...
              <div></div>
              {
                ...
                <div className='flex flex-col gap-2 justify-end'>
                  <p className='text-sm text-green-500 text-center sm:min-w-48 py-2 border rounded border-green-500 hover:bg-green-500 hover:text-white transition-all duration-300'>Complete</p>
                </div>
                : <div className='flex flex-col gap-2 justify-end'>
