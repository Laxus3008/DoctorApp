...
const bookAppointment = async (req, res) => {
    try {
        ...
        console.log(error);
        res.json({success: false, message: "something went wrong in userController bookappointment " + error.message})
    }
}
...
const listAppointment = async (req, res) => {
    ...
    try {
        ...
        console.log(error);
        res.json({success: false, message: "something went wrong in userController listAppointments " + error.message})
    }
}
...
const cancelAppointment = async (req, res) => {
    try {
        ...
        console.log(error);
        res.json({success: false, message: "something went wrong in userController cancelAppointment " + error.message})
    }
}
...
const paymentRazorpay = async (req, res) => {
    ...
    try {
        ...
        console.log(error);
        res.json({success: false, message: "something went wrong in userController paymentRazorpay " + error.message})
    }
}
...
const verifyRazorpay = async (req, res) => {
    try {
        ...
        console.log(error);
        res.json({success: false, message: "something went wrong in userController verifyRazorpay " + error.message})
    }
}
